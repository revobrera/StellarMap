...
"}")
    ...
    def retranslateUi(self, ApplicationWindow):
        """
        This function sets the text and properties for various widgets in the 
        ApplicationWindow interface.

        Args:
        ApplicationWindow: The main window of the application.
        """
        ApplicationWindow.setWindowTitle(QCoreApplication.translate("ApplicationWindow", "ApplicationWindow", None))
        self.btn_toggle_menu.setText("")
        self.label_title_bar_top.setText(QCoreApplication.translate("ApplicationWindow", "Main Window - Base", None))
        self.btn_minimize.setText("")
        self.btn_maximize_restore.setText("")
        self.btn_close.setText("")
        self.label_top_info_1.setText(QCoreApplication.translate("ApplicationWindow", "C:\Program Files\Blender Foundation\Blender 2.82", None))
        self.label_top_info_2.setText(QCoreApplication.translate("ApplicationWindow", "| HOME", None))
        self.label_user_icon.setText(QCoreApplication.translate("ApplicationWindow", "RO", None))
        self.labelBoxBlenderInstalation.setText(QCoreApplication.translate("ApplicationWindow", "BLENDER INSTALLATION", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("ApplicationWindow", "Your Password", None))
        self.pushButton.setText(QCoreApplication.translate("ApplicationWindow", "Open Blender", None))
        self.labelVersion_3.setText(QCoreApplication.translate("ApplicationWindow", "Ex: C:Program FilesBlender FoundationBlender 2.82 blender.exe", None))
        self.checkBox.setText(QCoreApplication.translate("ApplicationWindow", "CheckBox", None))
        self.radioButton.setText(QCoreApplication.translate("ApplicationWindow", "RadioButton", None))
        self.comboBox.setItemText(0, QCoreApplication.translate("ApplicationWindow", "Test 1", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("ApplicationWindow", "Test 2", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("ApplicationWindow", "Test 3", None))
        self.commandLinkButton.setText(QCoreApplication.translate("ApplicationWindow", "CommandLinkButton", None))
        self.commandLinkButton.setDescription(QCoreApplication.translate("ApplicationWindow", "Open External Link", None))

        # Set the text for the horizontal header items
        for i in range(self.tableWidget.columnCount()):
                item = self.tableWidget.horizontalHeaderItem(i)
                item.setText(QCoreApplication.translate("ApplicationWindow", str(i), None))

        # Set the text for the vertical header items
        for i in range(self.tableWidget.rowCount()):
                item = self.tableWidget.verticalHeaderItem(i)
                item.setText(QCoreApplication.translate("ApplicationWindow", "New Row", None))

        # Disable sorting while setting the items
        self.tableWidget.setSortingEnabled(False)

        # Set the items for each cell in the table
        for i in range(self.tableWidget.rowCount()):
                for j in range(self.tableWidget.columnCount()):
                        item = QTableWidgetItem()
                        self.tableWidget.setItem(i, j, item)

        # Re-enable sorting after setting the items
        self.tableWidget.setSortingEnabled(True)

        self.tableWidget.item(0, 0).setText("Test")
        self.tableWidget.item(0, 1).setText("Text")
        self.tableWidget.item(0, 2).setText("Cell")
        self.tableWidget.item(0, 3).setText("Line")
        # self.tableWidget.setSortingEnabled(__sortingEnabled)

        self.label_credits.setText("https://github.com/revobrera/StellarMap")
        self.label_version.setText("v0.4.0")

        self.label.setText("Charts Area")
        self.label.setStyleSheet("background-color: #261D45")

        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_data), "UPSTREAM CREATOR ACCOUNTS")
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_json), "JSON")
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_toml), "TOML")
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_terminal), "TERMINAL")
        self.pushButton.setText("Open Blender")
        self.lineEdit.setPlaceholderText("Search Stellar Address")
