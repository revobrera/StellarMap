...
"}")
        # icon = QIcon()
        # icon.addFile(u":/16x16/icons/16x16/cil-magnifying-glass.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/16x16/icons/16x16/cil-folder-open.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/16x16/icons/16x16/cil-link.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
