...
### Identify upstream creator accounts given a Stellar account
 <img src="/docs/source/images/stellarmap_prototype_data_v0_3_0_swisscustody_org.PNG" width="100%" title="StellarMap DATA tab">

### Display json outputs of current session
 <img src="/docs/source/images/stellarmap_prototype_json_v0_3_0_swisscustody_org.PNG" width="100%" title="StellarMap JSON tab">
